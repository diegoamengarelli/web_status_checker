...
def check_websites_cli():
    ...
    parser.add_argument(
        "urls", metavar="URL", type=str, nargs="+", help="URLs to check"
    )
    parser.add_argument(
        "-g",
        "--get",
    ...
    parser.add_argument(
        "-p", "--post", action="store_const", const="POST", help="Use POST request"
    )
    parser.add_argument(
        "-o", "--output", type=str, help="Output file to save the results"
    )
